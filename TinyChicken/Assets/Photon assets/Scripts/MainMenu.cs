...
public class MainMenu : Photon.MonoBehaviour
{
    ...
    void RoomBrowser(int id)
    {
        ...
        if (GUILayout.Button("GO", GUILayout.Height(50), GUILayout.Width(100)))
        {
    ...
    void MainGUI()
    {
        ...
        PhotonNetwork.playerName = GUI.TextField(new Rect(14, 310, 180, 20), (PhotonNetwork.playerName == null) ? string.Empty : PhotonNetwork.playerName);
